...
`locales/`, `fixtures/`, the whole of `rules/`, `schema/`, `VERSION` and `UNICODE`. The package and
its tests read only part of that — the locale and fixture data, `rules/order.json` and
